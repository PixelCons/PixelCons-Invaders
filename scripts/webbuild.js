...
const appStyleSheets = [
	...
	resolvePath("src/app/pages/mint/mint.view.css"),
	resolvePath("src/app/pages/explore/explore.view.css"),
...
const appHTML = [
	...
	resolvePath("src/app/pages/explore/explore.view.html"),
	resolvePath("src/app/pages/mint/mint.view.html"),
...
const appContracts = [
	...
	resolvePath("artifacts/contracts/pixelcons/PixelCons.sol/PixelCons.json"),
	resolvePath("artifacts/contracts/PixelConInvaders.sol/PixelConInvaders.json"),
	resolvePath("artifacts/contracts/PixelConInvadersBridge.sol/PixelConInvadersBridge.json")
];
